...
namespace Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20251212235405_AddFractionalOwnerships")]
    partial class AddFractionalOwnerships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ContractGeneration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AbiData")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("BytecodeData")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("DeploymentAddress")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("GeneratedContract")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entities.FractionalOwnership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("BuyerWalletLinkedAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("FractionAmount")
                        .HasPrecision(18, 8)
                    ...
                    b.Property<bool>("TransferSuccessful")
                        .HasColumnType("boolean");

                    b.Property<string>("TransferTransactionHash")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.HasIndex("BuyerWalletLinkedAccountId");

                    b.HasIndex("MintAddress");

                    b.HasIndex("RwaTokenId");

                    b.ToTable("FractionalOwnerships");
                });
            ...
            modelBuilder.Entity("Domain.Entities.RwaToken", b =>
                {
                    ...
                    b.Property<Guid?>("WalletLinkedAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WalletLinkedAccountId");
            ...
            modelBuilder.Entity("Domain.Entities.Trust", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal>("AnnualDistributionRate")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("MinimumPropertyValue")
                        .HasColumnType("numeric");
                    ...
                    b.Property<string>("QualifiedCustodian")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("TrustProtector")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal>("TrusteeFeeRate")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Domain.Entities.TrustProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("AnnualRentalIncome")
                        .HasColumnType("numeric");

                    b.Property<string>("AppraisalDocumentHash")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("InsuranceDocumentHash")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SurveyDocumentHash")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("TitleDocumentHash")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("TokenNaming")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entities.ContractGeneration", b =>
                {
                    b.HasOne("Domain.Entities.TrustProperty", "Property")
                        .WithMany("ContractGenerations")
                        .HasForeignKey("PropertyId");

                    b.HasOne("Domain.Entities.Trust", "Trust")
                        .WithMany("ContractGenerations")
            ...
            modelBuilder.Entity("Domain.Entities.FractionalOwnership", b =>
                {
                    b.HasOne("Domain.Entities.WalletLinkedAccount", "BuyerWalletLinkedAccount")
                        .WithMany()
                        .HasForeignKey("BuyerWalletLinkedAccountId")
                    ...
                    b.Navigation("BuyerWalletLinkedAccount");
            ...
            modelBuilder.Entity("Domain.Entities.RwaToken", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.WalletLinkedAccount", "WalletLinkedAccount")
                        .WithMany("RwaTokens")
                        .HasForeignKey("WalletLinkedAccountId");
                    ...
                    b.Navigation("WalletLinkedAccount");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Trust", b =>
                {
                    b.Navigation("ContractGenerations");
